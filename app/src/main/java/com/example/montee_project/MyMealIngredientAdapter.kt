...
class MyMealIngredientAdapter(
    private val ingredientList: List<IngredientDB>,
    ...
    class MyMealIngredientViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(myIngredientDB: IngredientDB, itemClickListener: OnItemClickListener) {
            ...
            ingredientText.text = String.format(
                ingredient_item_string,
                myIngredientDB.name,
                myIngredientDB.amount,
                myIngredientDB.measurement
            )
    ...
    override fun onBindViewHolder(holder: MyMealIngredientViewHolder, position: Int) {
        ...
        val ingredient_item_string =
            holder.itemView.context.getString(R.string.ingredient_item_string)
        holder.ingredientText.text = String.format(
            ingredient_item_string,
            myIngredientDB.name,
            myIngredientDB.amount,
            myIngredientDB.measurement
