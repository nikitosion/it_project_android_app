...
//            1031, 104,
//            listOf(
//                Ingredient("1", 0.125), Ingredient("2", 0.05),
//                Ingredient("3", 1.0), Ingredient("4", 0.025), Ingredient
//                    ("5", 0.05), Ingredient("6", 0.05), Ingredient("7", 0.025),
//                Ingredient("8", 2.0), Ingredient("9", 0.005), Ingredient("10", 0.005)
//            ),
...
//
//        val meal_cesar = Meal(
//            "2", "Салат «Цезарь»", null, 30, "лёгкая",
//            5046, 451, listOf(
//                Ingredient("11", 0.1), Ingredient("12", 0.1),
...
//                InstructionStep(
//                    listOf(Ingredient("11")),
//                    "Промыть, просушить и нарвать на небольшие кусочки листья салата, отложить в холодильник."
//                ),
//                InstructionStep(
//                    listOf(Ingredient("15"), Ingredient("16")),
//                    "В горячую сковородку положить сливочное масла. После того, как оно полностью расплавится и начнет шипеть, кинуть нарезанный на пластины зубчик чеснока."
//                ),
//                InstructionStep(
//                    listOf(Ingredient("15"), Ingredient("16"), Ingredient("14")),
//                    "В ту же сковородку добавить еще сливочного масла и зубчик чеснока. В это время нарезать на небольшие кубики хлеб. Положить в сковороду и обжаривать до румяной корочки. Желательно непрерывно помешивать, чтобы не подгорело."
//                ),
//                InstructionStep(
//                    listOf(Ingredient("12"), Ingredient("14"), Ingredient("17")),
...
//        )
//
//        val meal_boloneze = Meal(
//            "3", "Болоньезе", null, 110, "средняя", 985, 12,
//            listOf(
//                Ingredient("18", 0.05), Ingredient("19", 1.0), Ingredient("20", 0.05),
...
//                        Ingredient("21")
//                    ),
//                    "Разогрейте оливковое масло в большой сковороде и добавьте измельченные чеснок, лук, морковь и сельдерей. Тушите на маленьком огне 5 минут до мягкости овощей."
//                ),
//                InstructionStep(
//                    listOf(
//                        Ingredient("23"),
...
//                        Ingredient("26")
//                    ),
//                    "Увеличьте огонь и добавьте фарш. Перемешайте деревянной лопаткой, разломав комочки. Добавьте говяжий бульон, вино, помидоры и петрушку. Доведите до кипения, уменьшите огонь и тушите 1,5 часа, иногда помешивая. Посолите и добавьте специи."
//                ),
//                InstructionStep(
//                    listOf(Ingredient("28")),
//                    "Перед подачей сварите спагетти, слейте и подавайте с пармезаном."
//                )
//            )
//        )
//
//        val meal_sirniki = Meal(
//            "4", "Сырники", null, 30, "лёгкая", 5890, 351,
//            listOf(
//                Ingredient("30", 0.125),
//                Ingredient("31", 0.025),
//                Ingredient("32", 1.0),
...
//                        Ingredient("33")
//                    ),
//                    "Творог нужно брать обязательно сухой и рассыпчатый, из мягкого не получится. Чем выше процент жирности, тем вкуснее будут сырники. Размять творог вилкой, смешать с яйцом, сахаром и ванилином. Затем добавить 90 г муки и перемешать."
//                ),
//                InstructionStep(
//                    listOf(Ingredient("33")),
//                    "Сырная масса не должна быть ни слишком сухой, ни слишком влажной. Смоченными в воде руками взять немного массы и скатать из нее шарик, затем сдавить шарик ладонями и придать сырнику плоскую форму. Обвалять сформованные сырники в муке."
//                ),
//                InstructionStep(
//                    listOf(Ingredient("36")),
//                    "На сковороде разогреть масло и на среднем огне обжарить сырники с обеих сторон до золотистой корочки. Готовые сырники выложить на бумажные полотенца, чтобы избавиться от лишнего жира. Подавать со сметаной."
//                )
//            )
//        )

//        val meals: MutableList<Meal> = mutableListOf(
//            meal_carbonara, meal_cesar, meal_boloneze, meal_sirniki,
...
//        val morningMealItems = meals.filter { it.tags?.contains("morning") ?: false }.take(6)
...
//            meals.filter { it.tags?.contains("interesting") ?: false }.take(6)
...
//        val seasonMealItems = meals.filter { it.tags?.contains("season") ?: false }.take(6)
//        listOfSeasonsMeal.adapter = MealAdapter(seasonMealItems)
        ...
        lifecycleScope.launch {
            ...
            Log.d("Server", "Response data: $meals")
